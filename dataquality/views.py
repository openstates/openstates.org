...
from .models import DataQualityIssue, IssueResolverPatch
...
def legislative_session_info(request, jur_id, identifier):
    ...
    return render(request, 'dataquality/legislative_session_info.html', context)
...
def list_issue_objects(request, jur_id, related_class, issue_slug):
    ...
    return render(request, 'dataquality/list_issues.html', context)
...
def retire_legislators(request, jur_id):
    ...
    context = {'jur_id': jur_id,
               'people': objects,
               'page_range': page_range}
    return render(request, 'dataquality/retire_legislators.html', context)
...
def list_retired_legislators(request, jur_id):
    ...
    context = {'jur_id': jur_id,
               'people': objects,
               'page_range': page_range}
    return render(request, 'dataquality/list_retired_legislators.html', context)
...
def name_resolution_tool(request, jur_id, category):
    ...
    return render(request, 'dataquality/unresolved.html', context)
...
def create_person_patch(request, jur_id):
    ...
    context = {'jur_id': jur_id,
               'people': people}
    return render(request, 'dataquality/create_person_patch.html', context)
...
def dataquality_exceptions(request, jur_id, issue_slug, action):
    ...
    if request.method == 'POST':
        ...
        context = {'jur_id': jur_id,
                   ...
                   'url_slug': url_slug,
                   'related_class': related_class}
        return render(request, 'dataquality/list_dataquality_exceptions.html',
                      context)

...
from crowdsource.forms import IssueForm, ResolverForm
...
class BaseFormTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.person = Person.objects.create(name='Name')
...
class ResolverFormTestCase(BaseFormTestCase):
    ...
    def test_resolverform_valid(self):
        form = ResolverForm(data={'jurisdiction': self.jur.id,
                                  ...
                                  'note': 'Resolvers',
                                  'reporter_name': 'Name',
                                  'reporter_email': 'name.surname@openstates.com',
                                  'category': 'name',
